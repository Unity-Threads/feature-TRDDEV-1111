...
def signup(request):
    ...
    if request.method == "POST" and "register" in request.POST:
        ...
        contact = request.POST.get("contact").lower()# Email OR mobile
        # contact = contact.lower() #(converts into  lowercase)
...
def login_view(request):
    ...
    if request.method == "POST" and "password_login" in request.POST:
        ...
        email_or_mobile = email_or_mobile.lower() #converts lower
        password = request.POST.get("password")
    ...
    # OTP LOGIN - Send OTP
        ...
        contact = contact.lower()  # converts lower
...
def forgot_password(request):
    ...
    if request.method == "POST" and "send_otp" in request.POST:
        contact = request.POST.get("email_or_mobile")
        contact = contact.lower()  #conveerts lowercase
...
def forgot_password_reset(request):
    ...
    user_key = user_key.lower() # converts lowercase
    context = {"errors": {}}
